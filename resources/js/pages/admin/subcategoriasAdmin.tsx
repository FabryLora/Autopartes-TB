import SubCategoriasAdminRow from '@/components/subcategoriasAdminRow';
            ...
            <div className="flex w-full flex-col p-6">
                ...
                <div className="mx-auto flex w-full flex-col gap-3">
                        ...
                        <table className="w-full border text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                            ...
                            <tbody className="text-center">
                                {subCategorias?.data?.map((subcategoria) => (
                                    <SubCategoriasAdminRow key={subcategoria.id} subcategoria={subcategoria} />
                                ))}
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="mt-4 flex justify-center">
                        {subCategorias.links && (
                            <div className="flex items-center">
                                {subCategorias.links.map((link, index) => (
                                    <button
                                        key={index}
                                        ...
                                        } ${index === 0 ? 'rounded-l-md' : ''} ${index === subCategorias.links.length - 1 ? 'rounded-r-md' : ''}`}
                    ...
                    <div className="mt-2 text-center text-sm text-gray-600">
                        Mostrando {subCategorias.from || 0} a {subCategorias.to || 0} de {subCategorias.total} resultados
                    </div>
                </div>
            </div>
        </Dashboard>
