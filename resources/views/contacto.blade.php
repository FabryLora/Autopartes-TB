...
@section('content')
    ...
    <div class="mx-auto flex w-full max-w-[1200px] flex-col gap-6 px-4 py-10 md:gap-10 md:px-0 md:py-20">
        ...
        <script src="https://www.google.com/recaptcha/api.js?render=6LeZSmYrAAAAAH809hRxY7g-VdoclyO_xPkjkLD9
                            "></script>
        <script>
            ...
            document.getElementById('contact-form').addEventListener('submit', function (event) {
                ...
                grecaptcha.ready(function () {
                    grecaptcha.execute('6LeZSmYrAAAAAH809hRxY7g-VdoclyO_xPkjkLD9', { action: 'submit' }).then(function (token) {
