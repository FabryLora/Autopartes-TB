...
<head>
    ...
    <title>Nueva solicitud de registro - Autopartes TB</title>
    <style>
        /* Estilos generales */
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Nuevo Mensaje de Registro</h1>
        </div>

        <div class="content">
            <p class="message-intro">Se ha recibido una nueva solicitud de registro a través de la página
                web.</p>
            ...
            <div class="contact-data">
                ...
                <div class="data-row">
                    <div class="data-label">Cuit:</div>
                    <div class="data-value">{{ $data['cuit'] }}</div>
                </div>
                ...
                <div class="data-row">
                    ...
                    <div class="data-value">{{ $data['provincia'] }}</div>
                </div>
