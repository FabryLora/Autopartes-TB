...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success_register', 'Cuenta creada correctamente');
    }
    ...
    public function store_cliente(Request $request)
    {
        ...
        Mail::to(Contacto::first()->mail)->send(new UserSignUpMail($data));

        Mail::to($user->email)->send(new UserGreetMail($data));
